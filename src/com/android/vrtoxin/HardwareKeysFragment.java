...
public class HardwareKeysFragment extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.hardware_keys_fragment);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mVolSteps) {
            ((VRToxinActivity)getActivity()).displaySubFrag(getString(R.string.volume_steps_fragment_title));
