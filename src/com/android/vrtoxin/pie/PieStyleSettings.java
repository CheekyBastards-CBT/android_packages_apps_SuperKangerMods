...
public class PieStyleSettings extends PreferenceFragment implements
        OnPreferenceChangeListener {

    public PieStyleSettings(){}
    ...
    private void updateStyleValues() {
        ...
        mShowSnap.setChecked(Settings.System.getInt(mResolver,
                Settings.System.PIE_SHOW_SNAP, 1) == 1);

        mShowText.setChecked(Settings.System.getInt(mResolver,
                Settings.System.PIE_SHOW_TEXT, 1) == 1);

        mShowBackground.setChecked(Settings.System.getInt(mResolver,
                Settings.System.PIE_SHOW_BACKGROUND, 1) == 1);

        mMirrorRightPie.setChecked(Settings.System.getInt(mResolver,
                Settings.System.PIE_MIRROR_RIGHT, 1) == 1);

        float defaultAlpha;
        try{
            defaultAlpha = Settings.System.getFloat(mResolver, Settings.System.PIE_BACKGROUND_ALPHA);
        } catch (Exception e) {
            defaultAlpha = 0.3f;
            Settings.System.putFloat(mResolver,
        ...
        float controlSize;
        try{
            controlSize = Settings.System.getFloat(mResolver, Settings.System.PIE_SIZE);
        } catch (Exception e) {
