...
public class PieTriggerSettings extends PreferenceFragment
        implements Preference.OnPreferenceChangeListener {

    public PieTriggerSettings(){}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSensitivity.setValue(Settings.System.getInt(mResolver,
    ...
    public void onPause() {
        super.onPause();
        getActivity().getContentResolver().unregisterContentObserver(mPieTriggerObserver);
    }

    private void updatePieTriggers() {
        int triggerSlots = Settings.System.getInt(mResolver,
        ...
        mDisableImeTriggers.setChecked(Settings.System.getInt(mResolver,
