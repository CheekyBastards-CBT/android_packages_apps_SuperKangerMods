...
import com.android.vrtoxin.utils.ButtonBarHandler;
import com.android.vrtoxin.utils.DialogCreatable;
import com.android.vrtoxin.utils.HelpUtils;

/**
 * Base class for Settings fragments, with some helper functions and dialog management.
 */
public abstract class VRToxinPreferenceFragment extends PreferenceFragment
        implements DialogCreatable {

    private static final String TAG = "VRToxinPreferenceFragment";

    private static final int DELAY_HIGHLIGHT_DURATION_MILLIS = 600;

    private static final String SAVE_HIGHLIGHTED_KEY = "android:preference_highlighted";

    private VRToxinDialogFragment mDialogFragment;
    ...
    public void onResume() {
        ...
        if (args != null) {
            mPreferenceKey = args.getString(VRToxinActivity.EXTRA_FRAGMENT_ARG_KEY);
    ...
    protected void showDialog(int dialogId) {
        ...
        mDialogFragment = new VRToxinDialogFragment(this, dialogId);
    ...
    public static class VRToxinDialogFragment extends DialogFragment {
        ...
        public VRToxinDialogFragment() {
            /* do nothing */
        }

        public VRToxinDialogFragment(DialogCreatable fragment, int dialogId) {
            mDialogId = dialogId;
        ...
        public void onStart() {
            ...
            if (mParentFragment != null && mParentFragment instanceof VRToxinPreferenceFragment) {
                ((VRToxinPreferenceFragment) mParentFragment).onDialogShowing();
            }
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                // This dialog fragment could be created from non-VRToxinPreferenceFragment
                if (mParentFragment instanceof VRToxinPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((VRToxinPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof VRToxinPreferenceFragment) {
                ...
                if (((VRToxinPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((VRToxinPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
