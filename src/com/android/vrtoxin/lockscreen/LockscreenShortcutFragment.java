...
public class LockscreenShortcutFragment extends PreferenceFragment implements
    ...
    private static final String PREF_BUTTONS_BAR =
            "buttons_bar_actions";
    ...
    private Preference mButtonsBar;
    ...
    public void refreshSettings() {
        ...
        mButtonsBar = (Preference)findPreference(PREF_BUTTONS_BAR);
        ...
        if (hideButtonsBar == 0) {
            ...
            catNotifications.removePreference(findPreference("buttons_bar_number_of_notifications"));
