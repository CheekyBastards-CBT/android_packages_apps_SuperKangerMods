...
package com.android.vrtoxin.display;
...
public class DozeSettingsFragment extends PreferenceFragment implements
    ...
    private static final String KEY_DOZE_TRIGGER_OPTIONS_CAT = "doze_trigger_options_cat";
    ...
    private PreferenceCategory mTriggerOptions;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.doze_fragment);
        ...
        mTriggerOptions = (PreferenceCategory) findPreference(KEY_DOZE_TRIGGER_OPTIONS_CAT);
        ...
        if (isPickupSensorUsedByDefault(activity)) {
            ...
            mTriggerOptions.removePreference(findPreference("doze_trigger_pickup"));
        }
        if (isSigmotionSensorUsedByDefault(activity)) {
            ...
            mTriggerOptions.removePreference(findPreference("doze_trigger_sigmotion"));
        }
