...
import com.android.vrtoxin.preferences.DefaultRingtonePreference;
import com.android.vrtoxin.preferences.IncreasingRingVolumePreference;
import com.android.vrtoxin.preferences.VolumeSeekBarPreference;
...
public class SoundFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.sound_fragment);
    ...
    private void updateRingPreference() {
        if (mRingPreference != null) {
            final boolean linkEnabled = Settings.System.getInt(mResolver,
    ...
    private void updateVibrateWhenRinging() {
        ...
        mVibrateWhenRinging.setChecked(Settings.System.getInt(mResolver,
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        public void register(boolean register) {
            if (register) {
                mResolver.registerContentObserver(VIBRATE_WHEN_RINGING_URI, false, this);
            } else {
