...
public class StatusBarNotificationIconsFragment extends PreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    public StatusBarNotificationIconsFragment(){}
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        StatusBarNotificationIconsFragment getOwner() {
            return (StatusBarNotificationIconsFragment) getTargetFragment();
        }
